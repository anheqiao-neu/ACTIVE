...
origin_dir  = r'D:\G\G\code+chenao\Research\yolov3\yolo3-pytorch-master\VOCdevkit\VOC2007\JPEGImages'
annota_dir = r'D:\G\G\研究性论文\新建文件夹'
target_dir1= r'D:\G\G\xml'

def divide_img(oriname):
    img_file = os.path.join(origin_dir, oriname + '.png')
