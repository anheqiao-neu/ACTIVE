...
#   Be sure to modify the classes before running
#   If there is no target information in the generated A, 
...
#   The order of classes set here should be the same as txt in the model_data
#-----------------------------------------------------#
...
def convert_annotation(year, image_id, list_file):
    ...
    in_file = open('F:\VOCdevkit\VOC2012\Annotations/%s.xml' %image_id, encoding='utf-8')
...
for year, image_set in sets:
    ...
    image_ids = open('F:\VOCdevkit/VOC%s/ImageSets/Main/%s.txt'%(year, image_set), encoding='utf-8').read().strip().split()
